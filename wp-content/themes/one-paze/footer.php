    ...
    <div class="footer-bottom">
        <div class="container clearfix">            
            ...
            <div class="site-info">
                ...
                <span class="sep"> | </span>
                <span><?php printf(esc_html__('WordPresss Theme: %1$s', 'one-paze'), '<a href="' . esc_url('https://accesspressthemes.com/wordpress-themes/one-paze/') . '" rel="designer">One Paze</a>'); ?> <?php _e('by ', 'one-paze'); ?><a href="https://accesspressthemes.com">AccessPress Themes</a></span>
            </div><!-- .site-info -->
        </div>
