<div class="theme-steps-list">
	...
	<div class="theme-steps">
		<h3><?php echo esc_html__('Step 1 - Read Full Documentation', 'one-paze'); ?></h3>
		...
		<a target="__blank" class="button" href="<?php echo esc_url('http://accesspressthemes.com/documentation/one-paze-doc'); ?>"><?php echo esc_html__('Read Documentation', 'one-paze'); ?></a>
	</div>
