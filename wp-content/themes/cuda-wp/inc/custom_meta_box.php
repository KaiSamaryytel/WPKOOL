                    ...
                    { // function that displays the form fields
                        ...
                        foreach ($inputs as $name => $type) {
                            ...
                            $lookup = array(
                                ...
                                "textarea" => "<textarea name='$id_name' cols='30' rows='10'>$value</textarea>",
                                "editor" => "",
                                ...
                                "upload" => "<input type='text' name='$id_name' id='$id_name' value='$value' /><a href=\"#\" class=\"dfmr-upload-external-file button\">Upload</a>"
                                );
                                ?>
                                ...
                                <p>
                                 ...
                                 // If a file was uploaded, display it below the input.
                                    ...
                                    if ( $type === 'upload') {
                                        ...
                                        ?>
                                        <script>
                                            !function($){jQuery(".dfmr-upload-external-file").click(function(e){e.preventDefault();var $el=$(this).parent(),uploader=wp.media({multiple:!1}).on("select",function(){var selection=uploader.state().get("selection"),attachment=selection.first().toJSON();$("input",$el).val(attachment.url),$("img",$el).attr("src",attachment.url).show()}).open()})}(jQuery);
                                        </script>
                                        <?php
                                    }
